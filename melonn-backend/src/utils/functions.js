...
const getRules = async (methodId, req, res) => {
  ...
  module.exports = {getRules, getOffDays, generateIntOrderNumber, handleWrongValidation, getFormatDate, nextBusinesDays, calculateOrderWeight, verifyWeight, verifyDayType, verifyTimeOfDay, getPromiseParams, caseIterator, calculatePromiseMin, calculatePromiseMax}